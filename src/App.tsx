...
const socialLinks = [
    {
        href: "https://discord.gg/qreY9hqt3S",
        label: "Discord",
    ...
    {
        href: "https://github.com/MVDW-SplashOS",
        label: "GitHub",
...
function SocialIcons({ variant }: { variant?: "hero" }) {
    const isHero = variant === "hero";
    return (
        <div className={`social-links${isHero ? " social-links--hero" : ""}`}>
            ...
            <div className={`container${ready ? " loaded" : ""}`}>
                ...
                <footer className="footer">
                    <p>
                        ...
                        SplashOS. All rights reserved. Logo by{" "}
                        <a
